...
public class GameHudOverlay {
    private static final ResourceLocation COIN_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HuntersMarket.MOD_ID, "textures/gui/coin.png");
    ...
    public static void addFloatingText(long amount) {
        ...
        String localizedText = Component.translatable("message.huntersmarket.sold", amount).getString();
        floatingTexts.add(new FloatingText(
    ...
    private static void renderPriceEvent(GuiGraphics graphics, Minecraft mc,
        ...
        String header = Component.translatable("hud.huntersmarket.price_event").getString()
